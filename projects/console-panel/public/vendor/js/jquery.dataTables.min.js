...
sNext:"<i class='fa fa-angle-right'></i>",sPrevious:"<i class='fa fa-angle-left'></i>"},sEmptyTable:"No data available in table",sInfo:"Showing _START_ to _END_ of _TOTAL_",sInfoEmpty:"Showing 0 to 0 of 0",sInfoFiltered:"(filtered from _MAX_ total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",

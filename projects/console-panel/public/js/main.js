(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.settings-row').each(function() {
            var $buttons = $(this).find('.icon:not(#enableLoader):not(#disableLoader)');
        ...
        const enableHorizontalMenu = () => {
            ...
            if($('html').attr('data-menu') === ('horizontal')) {
                ...
                $('#navBarSizeGroup').hide().find('.icon').removeClass('active');
                $('#navBarSizeGroup').hide().find('.icon').first().addClass('active');
        ...
        if (horizontalMenu === "enabled") {
            ...
            $('#horizontalMenu').addClass('active').parent().siblings().find('.icon').removeClass('active');
        }
        ...
        if (twoColumnMenu === "enabled") {
            enableTwoColumnMenu();
            $('#twoColumnMenu').addClass('active').parent().siblings().find('.icon').removeClass('active');
        }
        ...
        if (verticalMenu === "enabled") {
            enableVerticalMenu();
            $('#verticalMenu').addClass('active').parent().siblings().find('.icon').removeClass('active');
        }
        ...
        if (flushMenu === "enabled") {
            enableFlushMenu();
            $('#flushMenu').addClass('active').parent().siblings().find('.icon').removeClass('active');
        }
        ...
        if (sidebarSmall === "enabled") {
            enableSidebarSmall();
            $('#sidebarSmall').addClass('active').parent().siblings().find('.icon').removeClass('active');
        }
        ...
        if (sidebarHover === "enabled") {
            enableSidebarHover();
            $('#sidebarHover').addClass('active').parent().siblings().find('.icon').removeClass('active');
        }
